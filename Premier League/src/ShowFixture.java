...
public class ShowFixture extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShowFixture frame = new ShowFixture();
	...
	public ShowFixture() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(ShowFixture.class.getResource("/Images/ShowFixture.jpg")));
		lblNewLabel_1.setBounds(1, 0, 628, 349);
	...
	public void load(){
		...
		try {
			...
			String sql1 = "select * from fixture";
			con = getConnection();
